...
{//list of days
  ...
  {//g is each students grades
    //console.log(g, "this is g")
    if(g[i].type=="homework")
    {//console.log(g[i].grade, "g[i].grade hw")
      hw_total=g[i].grade*2;
    }
    else if(g[i].type=="quiz")
    {//console.log(g[i].grade, "g[i].grade quiz")
      qz_total=g[i].grade*10;
    }
    else if(g[i].type=="test")
    {//console.log(i, g[i].grade, "i, g[i].grade test")
      tt_total=g[i].grade;
    }
    else if(g[i].type=="final")
    {
    //  console.log(g[i].grade, "g[i].grade final")
      fl_total=g[i].grade;
    }
    ...
    console.log(individualAv, "individualav")
